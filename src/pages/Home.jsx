...
const Home = () => {
  ...
  return (
    <div className="bg-[#FBF9F7]">
      ...
      <main className="min-h-screen w-full flex flex-col md:flex-row md:h-screen font-['Inter']">
        ...
        <section className="w-full md:w-[45%] flex items-center px-6 md:px-16 lg:px-24 py-20 md:py-0">
          <div className="w-full pt-10 md:pt-0">
            ...
            <p className="mt-5 text-gray-500 text-sm leading-relaxed max-w-sm font-light tracking-wide">
            ...
            <div className="mt-10 md:mt-16 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-8 pointer-events-auto">
              <Link to="/projects" className="group relative flex h-[56px] sm:w-[200px] items-center justify-center bg-[#A65A44] overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] hover:bg-[#6B6B6B]">
                <span className="relative z-10 text-[10px] uppercase tracking-[0.3em] font-bold text-white transition-transform duration-700 group-hover:scale-110">
                  View Projects
                </span>
              </Link>
              <Link to="/contact" className="group relative flex h-[56px] sm:w-[200px] items-center justify-center overflow-hidden transition-all duration-700">
                <span className="relative z-10 text-[10px] uppercase tracking-[0.3em] font-bold text-gray-400 transition-all duration-700 group-hover:text-black group-hover:scale-105">
                  Work With Us
                  <span className="absolute -bottom-1 left-1/2 w-0 h-[1px] bg-black -translate-x-1/2 transition-all duration-700 group-hover:w-full" />
                </span>
              </Link>
            </div>
          </div>
        ...
        <section className="w-full md:w-[55%] relative h-[450px] md:h-full flex flex-col justify-center p-6 md:p-10 lg:p-16">
          <div className="absolute rounded-xl bg-[#E8E8E8]" style={{ top: '20%', bottom: '20%', left: '10%', right: '9%', transform: 'translateX(18px)', zIndex: 0 }} />
          <div className="relative overflow-hidden rounded-xl bg-gray-100" style={{ height: '75%', zIndex: 1, marginRight: '18px' }}>
          ...
          <div className="mt-8 flex justify-center space-x-3" style={{ position: 'relative', zIndex: 1 }}>
            {images.map((_, index) => (
              <button key={index} onClick={() => setCurrentSlide(index)} className={`h-[2px] transition-all duration-500 cursor-pointer ${index === currentSlide ? 'w-12 bg-[#6B6B6B]' : 'w-6 bg-gray-200'}`} />
            ))}
          </div>
        </section>
      </main>
      ...
      {/* STATS */}
      <div data-animate className="relative z-20 -mt-10 md:-mt-20">
        <StatsSection />
      </div>
      ...
      <section className="w-full bg-[#FBF9F7] py-20 md:py-30 px-6 md:px-16 lg:px-24 font-['Inter']">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-24">
          ...
          <div data-animate className="w-full md:w-[45%] relative flex-shrink-0">
          ...
          <div data-animate data-delay="200" className="w-full md:w-[55%]">
            <span className="text-[9px] uppercase tracking-[0.5em] text-[#6B6B6B] font-semibold">The Architect</span>
            ...
            <Link to="/about" className="group inline-flex items-center gap-3 mt-10 text-[10px] uppercase tracking-[0.4em] font-bold text-[#1A1A1A] hover:text-[#A65A44] transition-colors duration-300">
              Read Full Story
